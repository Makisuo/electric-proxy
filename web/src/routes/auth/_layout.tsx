...
const quotes: {
	...
	},
	{
		...
		author: {
			...
			image: "https://media.licdn.com/dms/image/D4E03AQE3_DloJSEeBw/profile-displayphoto-shrink_800_800/0/1706486799593?e=1715212800&v=beta&t=TOBQZjsyk3fVZLfuYtdZSKQoM22Gaf9ggMgsGzsNq-4",
...
const Logo: React.FC<{ className?: string }> = ({ className }) => (
	<svg className={className} xmlns="http://www.w3.org/2000/svg" width="93" height="40" viewBox="0 0 93 40">
		<path
		...
		<div className="bg-black">
			...
			<nav className="container flex h-16 items-center justify-between">
				...
				<Link
					...
					target="_blank"
				>
					<IconFileText className="size-4" strokeWidth={1} />
					Documentation
				</Link>
			</nav>
			<div className="-mt-16 flex min-h-screen pt-16">
				<div className="container relative flex flex-col items-center justify-center gap-8 lg:w-2/5">
					...
					<div className="flex items-center justify-center ">
						<p className="text-balance p-4 text-center text-white/50 text-xs">
							By continuing, you agree to Hazel's{" "}
				...
				<div className="hidden h-[calc(100vh-4rem)] w-3/5 items-center justify-center lg:flex">
					<div className="relative max-w-lg pl-12">
						...
						<div className="mt-8 flex items-center">
							<Avatar src={quote.author.image} initials={quote.author.name} className="size-8" />
							<Link
