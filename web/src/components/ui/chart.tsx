...
const Chart = forwardRef<
	...
	React.ComponentProps<"div"> & {
		responsiveProps?: Omit<React.ComponentProps<typeof ResponsiveContainer>, "children">
		config: ChartConfig
		children: React.ComponentProps<typeof ResponsiveContainer>["children"]
	}
>(({ id, className, children, config, responsiveProps, ...props }, ref) => {
	...
	return (
		<ChartContext.Provider value={{ config }}>
			...
			>
				...
				<ResponsiveContainer {...responsiveProps} width="100%" height="100%">
					{children}
				</ResponsiveContainer>
			</div>
